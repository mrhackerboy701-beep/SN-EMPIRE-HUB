...
import { Dashboard, Services, Payment, Profile } from './pages/User';
import { AdminDashboard, AdminUsers, AdminPayments, AdminSettings } from './pages/Admin';
...
export default function App() {
  ...
  const [themeMode] = useState(localStorage.getItem('themeMode') || 'dark');
  ...
  useEffect(() => {
    ...
    fetch('/api/theme') // can fetch globally without auth
      .then(res => res.json())
      .then(data => {
